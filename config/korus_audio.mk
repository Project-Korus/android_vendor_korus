...
ALARM_PATH := vendor/korus/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/korus/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/korus/prebuilt/common/media/audio/ringtones
